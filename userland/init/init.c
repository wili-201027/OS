...
extern void fs_server_start(void);
extern void device_server_start(void);
extern void gpu_server_start(void);
extern void quantum_server_start(void);
extern void graphics_server_start(void);
extern void sys_yield(void);
extern int userland_launch_app(const char *name, int argc, char **argv);
